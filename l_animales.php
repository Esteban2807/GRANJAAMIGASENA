...
$puedeEditar   = in_array($rolId, [1,2,3,5]);
$puedeEliminar = in_array($rolId, [1,2,5]);
$numAcciones   = ($puedeEditar ? 1 : 0) + ($puedeEliminar ? 1 : 0);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <main class="container">
        <div class="content-card">
            <div class="card-header">
                <h1 class="card-title"><i class="fas fa-id-card"></i> Animales</h1>
                <?php if (in_array($rolId, [1,2,3,5])): ?>
                    ...
                    <table class="data-table" id="tabla-animales">
                        <thead>
                            <tr>
                                ...
                                <th>ID Madre</th>
                                <th>Observaciones</th>
                                <?php if ($numAcciones > 0): ?>
                                <th colspan="<?= $numAcciones ?>">Acciones</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                        <tbody>
