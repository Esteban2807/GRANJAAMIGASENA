    ...
    <main class="container">
        <div class="content-card">
            <div class="card-header">
                <h1 class="card-title"><i class="fas fa-syringe"></i> Vacunaciones</h1>
                <a href="cr_vacunacion.php" class="btn-create"><i class="fas fa-plus-circle"></i> Crear Nuevo</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($res as $registro): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($registro['id_vacuna']); ?></td>
                                    ...
                                    <td>
                                        <form id="form-eliminar-<?php echo $registro['id']; ?>" action="controllers/vacunaciones/op_eliminar.php" method="POST" class="form-inline">
                                            <input type="hidden" name="id" value="<?php echo htmlspecialchars($registro['id']); ?>">
