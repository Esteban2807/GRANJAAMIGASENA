...
include_once 'class/c_razas.php';
$animales = new animales();
$listaAnimales = $animales->listar();
$especies = new especies();
$listaEspecies = $especies->listar();
$razas = new razas();
$listaRazas = $razas->listar();
...
<body class="bodyAgregarAnimal">
    ...
    <main>
        <form action="">
            ...
            <b><label for="id_especie">Especie</label></b>
            ...
            <p><label for="id_raza">Raza</label></p>
            <select name="id_raza">
                <option value="">Seleccionar...</option>
                <?php foreach ($listaRazas as $lista) { ?>
                    <option value="<?= $lista['id'] ?>"><?= $lista['nombre'] ?></option>
                <?php } ?>
            </select>
                ...
                <div>
                    <div>
                        ...
                        <select name="id_padre">
                            <option value="">Seleccionar...</option>
                            <?php foreach ($listaAnimales as $lista) { ?>
                                <option value="<?= $lista['id'] ?>"><?= $lista['nombre'] ?></option>
                            <?php } ?>
                        </select>
