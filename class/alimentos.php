...
class alimentos extends basedatos
{
    ...
    {
        $sql = sprintf(
            "INSERT INTO alimentos (nombre,tipo,marca_proveedor,stock_actual,unidad_medida,fecha_vencimiento) VALUES ('%s','%s','%s','%s','%s','%s')",
            $this->nombre,
            $this->tipo,
    ...
    {
        $sql = sprintf(
            "UPDATE alimentos SET nombre='%s', tipo='%s', marca_proveedor='%s', stock_actual='%s', unidad_medida='%s', fecha_vencimiento='%s' WHERE id=%s",
            $this->nombre,
            $this->tipo,
            $this->marca_proveedor,
            $this->stock_actual,
    ...
    {
        $sql = sprintf("SELECT * FROM alimentos WHERE id = %s", $this->id);
        $this->conectar();
        $this->ejecutarSQL($sql);
