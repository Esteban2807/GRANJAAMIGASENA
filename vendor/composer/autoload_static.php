...
class ComposerStaticInit2185d2f99bcd56787481d9357a5972d3
{
    ...
    public static $classMap = array (
        ...
        'Tipos_documento' => __DIR__ . '/../..' . '/class/tipos_documento.php',
        'alimentaciones' => __DIR__ . '/../..' . '/class/alimentaciones.php',
        'alimentos' => __DIR__ . '/../..' . '/class/alimentos.php',
        'animales' => __DIR__ . '/../..' . '/class/animales.php',
        'atenciones_veterinarias' => __DIR__ . '/../..' . '/class/atenciones_veterinarias.php',
        'basedatos' => __DIR__ . '/../..' . '/class/basedatos.php',
        'cargos' => __DIR__ . '/../..' . '/class/cargos.php',
        'especies' => __DIR__ . '/../..' . '/class/especies.php',
        'medicaciones' => __DIR__ . '/../..' . '/class/medicaciones.php',
        'medicamentos' => __DIR__ . '/../..' . '/class/medicamentos.php',
        'nacimientos' => __DIR__ . '/../..' . '/class/nacimientos.php',
        'partos' => __DIR__ . '/../..' . '/class/partos.php',
        'razas' => __DIR__ . '/../..' . '/class/razas.php',
        'usuarios' => __DIR__ . '/../..' . '/class/usuarios.php',
        'vacunaciones' => __DIR__ . '/../..' . '/class/vacunaciones.php',
        'vacunas' => __DIR__ . '/../..' . '/class/vacunas.php',
    );
