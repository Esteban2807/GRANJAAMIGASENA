...
// Crear objeto Tipos_documento
$tipos_documento = new Tipos_documento();

/* ¿Viene búsqueda? */
if (isset($_GET['buscar']) && trim($_GET['buscar']) !== '') {
    $res = $tipos_documento->buscar($_GET['buscar']);
} else {
    $res = $tipos_documento->listar();
}
?>
...
<head>
    ...
    <title>Listado de Tipo de Documento</title>
                                    ...
                                    <td>
                                        <form id="form-eliminar-<?php echo $registro['id']; ?>"
                                            ...
                                            <button type="button"
                                                ...
                                                data-nombre="<?php echo htmlspecialchars($registro['nombre'] ?? 'este tipo de documento', ENT_QUOTES); ?>">
